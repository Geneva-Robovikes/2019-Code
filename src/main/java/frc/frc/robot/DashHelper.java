...
public class DashHelper {
    ...
    public NetworkTableEntry sbGyroAngle, sbTeleSpeed,sbTurnSpeed, sbRedLight, sbGreenLight, sbBlueLight, sbRate;
    public void startDash(){
        ...
        sbRedLight = mainTab.add("Red Light", 0).getEntry();
        sbGreenLight = mainTab.add("Green Light", 0).getEntry();
        sbBlueLight = mainTab.add("Blue Light", 0).getEntry();
        sbRate = mainTab.add("Rate", 1).getEntry();
